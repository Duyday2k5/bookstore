import { Badge, Descriptions, Divider, Space, Table, Tag, Modal, Image, Row, Col, Card, Breadcrumb } from "antd";
        ...
        <div style={{ background: '#efefef', padding: "20px 0" }}>
            <div style={{ maxWidth: 1440, margin: '0 auto' }}>
                ...
                <div style={{ padding: "20px", background: '#fff', borderRadius: 5 }}>
                    <div style={{ margin: "15px 0", fontSize: 20, fontWeight: 600 }}>Lịch sử đặt hàng</div>
